...
import com.fayezcoder.write.old.managers.ThemeManager;
...
public class NoteEditFragment extends Fragment {
    ...
    IntentFilter filter = new IntentFilter("com.fayezcoder.write.old.DELETE_NOTES");
    ...
    // Saves notes to /data/data/com.fayezcoder.write.old/files
    private void saveNote() throws IOException {
        ...
        if(contents.equals("") && filename.equals("draft"))
            ...
            listNotesIntent.setAction("com.fayezcoder.write.old.LIST_NOTES");
    ...
    public void onDeleteDialogPositiveClick() {
        ...
        if(getActivity().getComponentName().getClassName().equals("com.fayezcoder.write.old.activity.MainActivity")
                && getActivity().findViewById(R.id.layoutMain).getTag().equals("main-layout-large")) {
